    ...
    <main class="signup auth">
      <div class="form-container">
        <form class="form" id="signupForm" method="POST">
          <div class="form-logo">
            <a href="/signup.html" aria-label="새로고침">
              <img
                src="images/logo.svg"
                alt="판다마켓 로고"
                width="396"
          ...
          <div class="form-contents">
            ...
            <div class="form-control">
              <label class="form-label" for="userNickname">
                닉네임
              </label>
              <input
                class="form-input"
            ...
            <div class="form-control">
              <label class="form-label" for="userPasswordChk">
                비밀번호 확인
              </label>
              <div class="visible-wrap">
                <input
            ...
            <div class="form-footer">
              이미 회원이신가요?
              <a class="form-footer-link" href="login.html">
                로그인
              </a>
            </div>
          </div>
