    ...
    <ImageFieldStyle className={className}>
      <label htmlFor="image-input">
        ...
        <div>
          ...
          <input onClick={handleClick} onChange={handleChange} type="file" id="image-input" name="image" />
        </div>
      </label>
          {preview &&<div> <img src={preview} alt="등록할 상품 미리보기" /> <img id="delete-button" src={deleteIcon} alt="미리보기 삭제버튼"/></div>} 
