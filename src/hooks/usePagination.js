...
-> 아니면 합성 컴포넌트? 이걸 알아볼까?
 */
export function usePagination(queryStrings, setQueryStrings, total, PAGINATION_MAX) {
    ...
    const isNextDisabled = pageStart + PAGINATION_MAX > maxPageLength;  /*훅에서 반환할 꺼 */
    ...
    const handlePageRequest = useCallback((e) => { /*훅에서 반환할 꺼 */
